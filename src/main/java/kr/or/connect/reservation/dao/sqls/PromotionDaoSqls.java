...
public class PromotionDaoSqls {
	public static final String SELECT_ALL = "SELECT id, product_id, product_image_id \n"
		+ "FROM promotion \n"
	...
	public static final String SELECT_ALL_WITH_IMAGE_URL = "SELECT id, product_id, product_image_url \n"
		+ "FROM promotion \n"
