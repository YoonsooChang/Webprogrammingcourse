...
<body>
			...
			<div class="card_body">
				...
				<div class="middle">
					<div class="card_detail">
						...
						<!-- [D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
						<div class="booking_cancel">
							<button id="cancelbtn-{{reservationInfoId}}" class="btn">
								<span>취소</span>
							</button>
						</div>
	...
	<script src="/reservation/js/RequestHandler.js">
